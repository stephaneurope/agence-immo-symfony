...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message ="La date d'arrivée doit etre ultérieure a la date d'aujourd'hui !", groups={"front"})
     */
    private $startDate;
     ...
     *  @Assert\GreaterThan(propertyPath="startDate", message ="La date de départ doit etre ultérieure a la date d'arrivée !")
     */
    private $endDate;
