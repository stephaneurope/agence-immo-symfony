...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre message doit faire plus de 100 caractères !")
     */
    private $content;
    ...
    /**
     * Permet s'obtenir un tableau des jours qui ne sont pas disponnibles pour cette annonce
     *
